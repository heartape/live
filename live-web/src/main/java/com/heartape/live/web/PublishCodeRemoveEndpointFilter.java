 ...
 */
@Slf4j
public class PublishCodeRemoveEndpointFilter extends OncePerRequestFilter {

    private static final String DEFAULT_HOOK_PLAY_URI = "/live/manage/code/remove";
    ...
    public PublishCodeRemoveEndpointFilter(HttpMessageConverter<ResponseConverter> httpMessageConverter, PublishCodeRepository publishCodeRepository) {
        this(httpMessageConverter, DEFAULT_HOOK_PLAY_URI, publishCodeRepository);
    }

    public PublishCodeRemoveEndpointFilter(HttpMessageConverter<ResponseConverter> httpMessageConverter, String hookPlayUri, PublishCodeRepository publishCodeRepository) {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
        ...
        publishCodeRepository.delete(id);
    ...
    private String id(HttpServletRequest request){
        try {
            ...
            CodeRemoveRequest codeRemoveRequest = objectMapper.readValue(body, CodeRemoveRequest.class);
            return codeRemoveRequest.getData();
        } catch (IOException e) {
    ...
    @Getter
    @Setter
    private static class CodeRemoveRequest {
