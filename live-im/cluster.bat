...
ssh root@192.168.31.101 "java -jar /opt/im/live-im.jar"
...
ssh root@192.168.31.102 "java -jar /opt/im/live-im.jar"
...
ssh root@192.168.31.103 "java -jar /opt/im/live-im.jar"
