-- ----------------------------
-- Table structure for live_message_file
-- ----------------------------
DROP TABLE IF EXISTS `live_message_file`;
CREATE TABLE `live_message_file`  (
...
-- ----------------------------
-- Table structure for live_message_greeting
-- ----------------------------
DROP TABLE IF EXISTS `live_message_greeting`;
CREATE TABLE `live_message_greeting`  (
...
-- ----------------------------
-- Table structure for live_message_image
-- ----------------------------
DROP TABLE IF EXISTS `live_message_image`;
CREATE TABLE `live_message_image`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `message_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- ----------------------------
-- Table structure for live_message_image_copy
-- ----------------------------
DROP TABLE IF EXISTS `live_message_image_copy`;
CREATE TABLE `live_message_image_copy`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- ----------------------------
-- Table structure for live_message_location
-- ----------------------------
DROP TABLE IF EXISTS `live_message_location`;
CREATE TABLE `live_message_location`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `message_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- ----------------------------
-- Table structure for live_message_sound
-- ----------------------------
DROP TABLE IF EXISTS `live_message_sound`;
CREATE TABLE `live_message_sound`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `message_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `size` int NOT NULL,
...
-- ----------------------------
-- Table structure for live_message_text
-- ----------------------------
DROP TABLE IF EXISTS `live_message_text`;
CREATE TABLE `live_message_text`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `message_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- ----------------------------
-- Table structure for live_message_video
-- ----------------------------
DROP TABLE IF EXISTS `live_message_video`;
CREATE TABLE `live_message_video`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `message_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
